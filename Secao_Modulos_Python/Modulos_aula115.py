...
# Unindo caminhos de arquivos
caminho = os.path.join('/home/users', 'Desktop', 'curso', 'arquivo.txt')
print(caminho)

# Divindo o caminho entre diretorio e nome do arquivo
diretorio, arquivo = os.path.split(caminho)
print(diretorio)
print(arquivo)

# Dividindo a extensao do arquivo
nome_arquivo, extensao_arquivo = os.path.splitext(arquivo)
print(nome_arquivo)
print(extensao_arquivo)

# Verificando se o caminho exite no sistema
caminho = os.path.join('C:/Users/nival/OneDrive/Área de Trabalho/Projetos')
print(os.path.exists(caminho))

# Retornando o caminho absoluto do caminho
