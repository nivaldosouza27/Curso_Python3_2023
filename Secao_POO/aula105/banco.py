...
class Banco:
    ...
    def _checa_conta_pretence_cliente(self, cliente, conta):
        if conta is cliente.conta:
            print('_checa_conta_pertence_cliente', True)
            return True
        print('_checa_conta_pertence_cliente', False)
        return False
    ...
    def autenticar(self, cliente: pessoas.Pessoa, conta: contas.Conta):
        return self._checa_agencia(conta) and \
            ...
            self._checa_conta_pretence_cliente(cliente, conta)
